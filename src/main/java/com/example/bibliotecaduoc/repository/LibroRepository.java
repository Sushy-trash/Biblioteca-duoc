...
public class LibroRepository {
    ...
    public LibroRepository(){
        ...
        listaLibros.add(new libro(1, "9789569646638", "Fuego y Sangre", "Penguin Random House Grupo Editorial", 2018, "George R. R. Martin"));
            ...
            listaLibros.add(new libro(8, "9780134685991", "Clean Architecture", "Prentice2ESCUELA DE ADMINISTRACIÓN Y NEGOCIOS Hall", 2017, "Robert C. Martin"));
